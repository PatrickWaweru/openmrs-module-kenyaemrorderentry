<%
    ...
    def actionRequired = [
            [label: "Collect new sample", iconProvider: "kenyaui", icon: "", label: "Collect new sample", href: ""],
...
<div class="ke-page-content">
    ...
    <div align="left" id="eligibleList">
        <fieldset>
            <legend style="color:steelblue">Collect New Sample list [ total = ${sampleListSize} ]</legend>
...
<script type="text/javascript">
    ...
    jq(function () {
        //Global Vars
        showActivePageOnManifestNavigation('Collect new sample');
    });
